...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('GameSettingController')->name('gamesetting.')->prefix('gamesetting')->group(function () {
        Route::get('/', 'index')->name('index');
    ...
    Route::controller('GameController')->name('game.')->prefix('game')->group(function () {
        ...
        Route::post('update/{id}', 'update')->name('update');
        Route::post('status/{id}', 'status')->name('status');
        Route::post('games/{id}/setwinner', 'setWinner')->name('setWinner');
    ...
    Route::controller('ReportController')->prefix('report')->name('report.')->group(function(){
     ...
     Route::controller('GameticketsController')->name('gametickets.')->prefix('gametickets')->group(function () {
        ...
        Route::get('/', 'gameList')->name('gameticket.list');
         Route::post('gameticket/{id}/set-winner', 'setWinner')->name('setWinner');
    });
