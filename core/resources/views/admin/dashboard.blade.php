...
@section('panel')
    ...
    {{-- <div class="row gy-4 mt-2">
      ...
      <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="" icon="las la-gamepad" title="Active Games" value="25$" bg="primary" outline="true" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" icon="las la-chart-line" title="Participation Rate" value="10%" bg="1" outline="true" />
        </div><!-- dashboard-w1 end -->
            <div class="col-xxl-3 col-sm-6">
        <x-widget style="6" icon="las la-star" title="Top Picked Numbers " value="34,23,23" bg="yellow" outline="true" />
    </div><!-- dashboard-w1 end -->
    </div>
